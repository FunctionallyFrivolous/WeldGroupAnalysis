...
function updateData() {
    ...
    const fringeColors = ["darkblue", "cyan", d3.color("green").brighter(2), "yellow", "orange", "red"]
    ...
    for (i=1; i<fringeColors.length-1; i++) {
        fringeStops.push((newScaleMax-newScaleMin)/(fringeColors.length-1)*i+newScaleMin)
    }
