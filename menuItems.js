...
const stressButtonProps = {
    x: 5, xinc: 29+5,
    y: windowHeight-34-yShift-35}

const stressMenuData = [
    {id: "inspect", text: "🔎", fontColor: "black", fontSize: "20px", lab: "Inspect Weld Stress", sub: "", 
        x: stressButtonProps.x + stressButtonProps.xinc*5, y: stressButtonProps.y, dy: "0.2em"},
    {id: "direct", text: "τ'", fontColor: "darkred", fontSize: "20px", lab: "Direct Shear Stress", sub: "", 
        x: stressButtonProps.x + stressButtonProps.xinc*2, y: stressButtonProps.y, dy: "0.1em"}, 
    {id: "torsional", text: "τ''", fontColor: "darkblue", fontSize: "20px", lab: "Torsional Shear Stress", sub: "", 
        x: stressButtonProps.x + stressButtonProps.xinc*3, y: stressButtonProps.y, dy: "0.1em"}, 
    {id: "max", text: "τ", fontColor: "indigo", fontSize: "18px", lab: "Max Shear Stress", sub: "max", 
        x: stressButtonProps.x + stressButtonProps.xinc*4, y: stressButtonProps.y, dy: "0.1em"}, 
    {id: "total", text: "τ", fontColor: "indigo", fontSize: "20px", lab: "Total Shear Stress", sub: "tot", 
        x: stressButtonProps.x + stressButtonProps.xinc, y: stressButtonProps.y, dy: "0em"}
]
...
const stressMenuBox = overlayGroup
    ...
    .attr("width", stressButtonProps.xinc*6+5+5)
    .attr("height", 30+5)
    .attr("rx", 5)
    .attr("ry", 5)
    // .attr("fill", "black")
