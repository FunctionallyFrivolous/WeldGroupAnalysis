...
const snapIcon = overlayGroup
    ...
    .attr("d", drawSnapIcon(settingsButtonProps.x + settingsButtonProps.width/2, 
        settingsButtonProps.y-buttonPitch + settingsButtonProps.height/2
    ))
    .style("pointer-events", "none")
    .style("display", "none")
...
const loadScaleIcon = overlayGroup
    ...
    .attr("y1", settingsButtonProps.y-buttonPitch*3+settingsButtonProps.height/2+6)
    .attr("y2", settingsButtonProps.y-buttonPitch*3+settingsButtonProps.height/2-5)
    .attr("stroke", "darkred")
    .attr("stroke-width", 2)
    .attr("opacity", 0.75)
...
const stressScaleIcon = overlayGroup
    ...
    .attr("y1", settingsButtonProps.y-buttonPitch*4+settingsButtonProps.height/2+7)
    .attr("y2", settingsButtonProps.y-buttonPitch*4+settingsButtonProps.height/2-4)
    .attr("stroke", "indigo")
    .attr("stroke-width", 2)
    .attr("opacity", 0.75)
...
const axIconPoints = {
    ...
    y1: settingsButtonProps.y-buttonPitch*2+settingsButtonProps.height/2+5, 
    l: 10
}
